      ...
      messages: [
        {
          role: "system",
          content:
            "You are an expert content writer specializing in Medium-style articles. Create engaging, informative, and well-structured articles based on video transcripts. Your articles should follow Medium's style with clear headings, short paragraphs, and a conversational yet professional tone.",
        },
        {
          role: "user",
      ...
      messages: [
        {
          role: "system",
          content:
            "You are an expert in LinkedIn content creation. Create professional, concise, and engagement-focused posts that follow LinkedIn best practices. Your posts should be scannable, include professional insights, and prompt engagement through questions or calls to action.",
        },
        {
          role: "user",
      ...
      messages: [
        {
          role: "system",
          content:
            "You are an educational content expert specializing in creating effective flashcards for learning and retention. Create clear, concise flashcards that capture key concepts, definitions, and facts from educational content.",
        },
        {
          role: "user",
      ...
      messages: [
        {
          role: "system",
          content:
            "You are a content strategist specializing in blog content ideation. Generate engaging, SEO-friendly blog title ideas based on video content.",
        },
        {
          role: "user",
      ...
      messages: [
        {
          role: "system",
          content:
            "You are a social media content specialist. Create engaging, scroll-stopping hooks and content ideas optimized for social media platforms based on video content.",
        },
        {
          role: "user",
      ...
      messages: [
        {
          role: "system",
          content:
            "You are a content researcher specializing in identifying logical follow-up questions that can deepen understanding or expand on topics covered in videos.",
        },
        {
          role: "user",
